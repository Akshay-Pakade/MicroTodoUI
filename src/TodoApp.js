...
const GET_TASKS_API_BASE_URL = "http://get-tasks-api.akshaypakade.shop";
const DELETE_TASK_API_BASE_URL = "http://delete-task-akshaypakade.shop";
const CREATE_TASK_API_BASE_URL = "http://add-task-api.akshaypakade.shop";
